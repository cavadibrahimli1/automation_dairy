...
wd.title("Restoran hesap uygulaması")
...
labelinformation = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Restoran hesap ugulaması",fg="red",bd=10,anchor='w')
labelinformation.grid(row=0,column=0)
labelinformation = Label(Tops, font=( 'aria' ,20, ),text=localtime,fg="red",anchor=W)
...
status = Label(frame2,font=('aria', 15, 'bold'),width = 16, text="-By Javad İbrahimli",bd=2,relief=SUNKEN)
...
labelref = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Sifariş No.",fg="black",bd=10,anchor='w')
...
labelfries = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Lahmacun",fg="black",bd=10,anchor='w')
...
labelLargefries = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Tavuk döner",fg="black",bd=10,anchor='w')
...
labelhamburger = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Et döner",fg="black",bd=10,anchor='w')
...
labelFilet = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Pizza ",fg="black",bd=10,anchor='w')
...
labelCheese_hamburger = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Dürüm",fg="black",bd=10,anchor='w')
...
labelDrinks = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Ayran",fg="black",bd=10,anchor='w')
...
labelcost = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Ücret",fg="black",bd=10,anchor='w')
...
labelService_Charge = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Servis Tutarı",fg="black",bd=10,anchor='w')
...
labelTax = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Vergi",fg="black",bd=10,anchor='w')
...
labelhamburgertotal = Label(frame1, font=( 'aria' ,16, 'bold' ),text="Hamburger sayı",fg="black",bd=10,anchor='w')
...
def price():
    ...
    ws.title("Menü")
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="YEMEK", fg="black", bd=5)
    labelinformation.grid(row=0, column=0)
    labelinformation = Label(ws, font=('aria', 15,'bold'), text="_____________", fg="white", anchor=W)
    labelinformation.grid(row=0, column=2)
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="FIYAT", fg="black", anchor=W)
    labelinformation.grid(row=0, column=3)
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="Lahmacun", fg="steel blue", anchor=W)
    labelinformation.grid(row=1, column=0)
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="25", fg="steel blue", anchor=W)
    labelinformation.grid(row=1, column=3)
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="Tavuk Döner", fg="steel blue", anchor=W)
    ...
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="Et Döner", fg="steel blue", anchor=W)
    ...
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="Pizza", fg="steel blue", anchor=W)
    ...
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="Dürüm", fg="steel blue", anchor=W)
    ...
    labelinformation = Label(ws, font=('aria', 15, 'bold'), text="Ayran", fg="steel blue", anchor=W)
...
buttonprice=Button(frame1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="FIYAT", bg="powder blue",command=price)
